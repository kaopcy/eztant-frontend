...
const Teachersearchbar = () => {
  return (
    <div className='relative'>
        <div className='flex w-full items-center lg:justify-between justify-center md:space-x-1 lg:space-x-2 flex-wrap sticky top-0'>
            <div className='text-secondary inline-block static m-[1.8%] lg:pl-[18%] xs:pl-0 text-4xl font-bold whitespace-nowrap'>
              รายชื่ออาจารย์
            </div>
